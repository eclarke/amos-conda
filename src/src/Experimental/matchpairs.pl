...
if ($help || !$res)
{
  print $USAGE;
  print "\n";
  print " Given 2 fq files extract the subset of paired reads that occur in both\n";
  print " and output to fq1.matched and fq2.matched. Orphan reads are reported to\n";
  print " fq1.orphans and fq2.orphans. The matching is done by readname, assuming\n";
  print " the /1 and /2 suffixes are present and can be stripped\n";
  print "\n";
  print "Required\n";
